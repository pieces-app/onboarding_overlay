...
class OnboardingStepperState extends State<OnboardingStepper> with TickerProviderStateMixin {
  ...
  TextStyle _setupTitleStyle(OnboardingStep step, TextTheme textTheme) {
    final TextStyle localTitleTextStyle =
        (textTheme.headlineSmall ?? headlineStyle).copyWith(color: step.titleTextColor);

    final TextStyle stepTitleTextStyle = (textTheme.headlineSmall ?? headlineStyle).copyWith(
  ...
  TextStyle _setupBodyStyle(OnboardingStep step, TextTheme textTheme) {
    final TextStyle localBodyTextStyle = (textTheme.bodyLarge ?? bodyTextStyle).copyWith(color: step.bodyTextColor);

    final TextStyle stepBodyTextStyle = (textTheme.bodyLarge ?? bodyTextStyle).copyWith(
    ...
    return Listener(
      ...
      onPointerDown: (PointerDownEvent details) {
        ...
        if (step.onTapCallback != null) {
          ...
          /// Only fire the callback and return if it's an overlay or hole tap.
          /// We'll handle label taps within the custom label.
          List<TapArea> accepted = <TapArea>[TapArea.overlay, TapArea.hole];
